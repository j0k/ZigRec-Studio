...
| `project_mark` | метки на времени проекта: перечислить, поставить, убрать, передвинуть, переименовать |
| `project_annotate` | надписи, стрелки и выноски поверх кадра: перечислить, добавить, убрать, передвинуть, сменить слова. Место — в тысячных долях кадра |
