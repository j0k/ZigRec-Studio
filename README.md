...
Записывает по-прежнему то самое окно, которое видит человек. Сервер только
передаёт ему просьбы — иначе вышли бы две программы, снимающие экран
одновременно.
