...
запись», «поставь на паузу», «подпиши это место», «сними окно браузера в png»,
«вырежи третью минуту и собери mp4». Двадцать один инструмент: всё, что делается
в окне записи и в редакторе, — запись и пауза, надписи на ходу, настройки и
устройства, снимки экрана, сведения о файлах, проекты и резка, экспорт и сведение
звука (долгие дела идут заданием, с вопросом «как оно там»).
