...
запись», «поставь на паузу», «подпиши это место». Восемь инструментов:
начать запись, остановить, пауза, надпись во время записи, состояние,
мониторы, окна, события последней записи.
