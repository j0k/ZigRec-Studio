...
«что внутри этого файла». Шестнадцать инструментов: начать запись, остановить,
пауза, надпись во время записи, состояние, настройки прочитать и поменять,
микрофоны, проба микрофона, снимок экрана, недавние записи, сведения о файле,
открыть в редакторе, мониторы, окна, события последней записи.
